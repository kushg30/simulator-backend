...
sql.push(
  `INSERT INTO simulations (simulation_id, name, description, total_rounds, duration_minutes) VALUES (` +
    ...
    `${q("ANP Phoenix — a leadership judgment simulation in the AI era. When can you trust what your AI just told you?")}, 4, 60) ` +
...
const DURATIONS = { 1: 17, 2: 16, 3: 14, 4: 13 };
...
const R = { 1: 17, 2: 16, 3: 14, 4: 13 };      // round length
const DELIB = { 1: 8, 2: 8, 3: 7, 4: 6 };      // deliberation starts
